...
const CloseNfts = () => {
  ...
  const closeAll = async () => {
    ...
    toast("Closing 10 accounts at a time.")
    toast(`${Math.ceil(tokens.length / 10)} transactions.`)
    // close 10 at a time
  ...
  return (
    <div>
      <div className='container items-center px-4 pt-24'>
        { loading && (
          <>
            <div className='flex'>
              <div className='items-center mx-auto h-12'>
                <Button
                  loading={loading}
                  id='btn-copy'
                  type='primary'
                  className=' h-12 py-40 text-2xl btn btn-primary bg-transparent'
                  disabled={true}
                >
                  Loading...
                </Button>
            ...
            <div className='flex'>
              <div className='h-12 mx-auto'>
                <Button
                  ...
                  id='btn-copy'
                  type='primary'
                  className=' h-12 py-40 text-2xl text-black btn btn-primary bg-transparent hover:text-white'
                  onClick={closeAll}
                >
